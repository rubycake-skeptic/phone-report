...
import lombok.Data;
import phonereport.DeviceApplication;
...
public class DeviceMgmt {
    ...
    public static DeviceMgmtRepository repository() {
        DeviceMgmtRepository deviceMgmtRepository = DeviceApplication.applicationContext.getBean(
    ...
    public void addDevice(AddDeviceCommand addDeviceCommand) {
        //implement business logic here:

        DeviceAdded deviceAdded = new DeviceAdded(this);
        deviceAdded.publishAfterCommit();
    }
